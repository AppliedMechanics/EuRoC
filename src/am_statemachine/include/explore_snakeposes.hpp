...
goal_queue[order_poses[0]].goal_pose.position.x = 0.336+0.92;
...
goal_queue[order_poses[0]].goal_config.q[0] = 0.92;
...
goal_queue[order_poses[1]].goal_pose.position.x = 0.336+0.92;
...
goal_queue[order_poses[1]].goal_config.q[0] =  0.92;
...
goal_queue[order_poses[2]].goal_pose.position.x = 0.336+0.92;
...
goal_queue[order_poses[2]].goal_config.q[0] = 0.92;
...
goal_queue[order_poses[3]].goal_pose.position.x = 0.336+0.92;
...
goal_queue[order_poses[3]].goal_config.q[0] = 0.92;
...
goal_queue[order_poses[4]].goal_pose.position.x = -0.245+0.92;
goal_queue[order_poses[4]].goal_pose.position.y = -0.37-0.92;
goal_queue[order_poses[4]].goal_pose.position.z = 0.785;
q_temp[4].setRPY(-2.659,-0.82,1.759);
goal_queue[order_poses[4]].goal_config.q[0] = 0.92;
goal_queue[order_poses[4]].goal_config.q[1] = -0.92;
...
goal_queue[order_poses[5]].goal_pose.position.y = 0.336+0.92;
...
goal_queue[order_poses[5]].goal_config.q[1] = 0.92;
...
goal_queue[order_poses[6]].goal_pose.position.y = 0.336+0.92;
...
goal_queue[order_poses[6]].goal_config.q[1] = 0.92;
...
goal_queue[order_poses[7]].goal_pose.position.y = 0.336+0.92;
...
goal_queue[order_poses[7]].goal_config.q[1] = 0.92;
...
goal_queue[order_poses[8]].goal_pose.position.y = 0.336+0.92;
...
goal_queue[order_poses[8]].goal_config.q[1] = 0.92;
...
goal_queue[order_poses[9]].goal_pose.position.x = -0.374-0.92;
goal_queue[order_poses[9]].goal_pose.position.y = -0.245+0.92;
goal_queue[order_poses[9]].goal_pose.position.z = 0.785;
q_temp[9].setRPY(-2.66,0.82,2.952);
goal_queue[order_poses[9]].goal_config.q[0] = -0.92;
goal_queue[order_poses[9]].goal_config.q[1] = 0.92;
